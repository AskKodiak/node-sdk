...
describe('Get Summary for Group Type', function () {
  it('sector', function (done) {
    askKodiak.getNaicsSummaryForGroupType('sector', {}).then(function (res) {
      var expect = {
  ...
  it('subsector', function (done) {
    askKodiak.getNaicsSummaryForGroupType('subsector', {}).then(function (res) {
      var expect = {
        '111': 'Crop Production',
  ...
  it('national-industry', function (done) {
    askKodiak.getNaicsSummaryForGroupType('national-industry', {}).then(function (res) {
      var expect = {
